...
const file_metrics_types_types_proto_rawDesc = "" +
	"\n" +
	"\x19metrics/types/types.proto\x12\x05types\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\"0\n" +
	"\n" +
	"StartEvent\x12\"\n" +
	"\x05Event\x18\x01 \x01(\v2\f.types.EventR\x05Event\"i\n" +
	"\x05Event\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\rR\x02ID\x12\x16\n" +
	"\x06Client\x18\x02 \x01(\bR\x06Client\x128\n" +
	"\tTimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tTimestamp\"\xa8\x01\n" +
	"\x15ThroughputMeasurement\x12\"\n" +
	"\x05Event\x18\x01 \x01(\v2\f.types.EventR\x05Event\x12\x18\n" +
	"\aCommits\x18\x02 \x01(\x04R\aCommits\x12\x1a\n" +
	"\bCommands\x18\x03 \x01(\x04R\bCommands\x125\n" +
	"\bDuration\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\bDuration\"\x84\x01\n" +
	"\x12LatencyMeasurement\x12\"\n" +
	"\x05Event\x18\x01 \x01(\v2\f.types.EventR\x05Event\x12\x18\n" +
	"\aLatency\x18\x02 \x01(\x01R\aLatency\x12\x1a\n" +
	"\bVariance\x18\x03 \x01(\x01R\bVariance\x12\x14\n" +
	"\x05Count\x18\x04 \x01(\x04R\x05Count\"d\n" +
	"\fViewTimeouts\x12\"\n" +
	"\x05Event\x18\x01 \x01(\v2\f.types.EventR\x05Event\x12\x14\n" +
	"\x05Views\x18\x02 \x01(\x04R\x05Views\x12\x1a\n" +
	"\bTimeouts\x18\x03 \x01(\x04R\bTimeoutsB)Z'github.com/relab/hotstuff/metrics/typesb\x06proto3"

var (
	file_metrics_types_types_proto_rawDescOnce sync.Once
	file_metrics_types_types_proto_rawDescData []byte
)

func file_metrics_types_types_proto_rawDescGZIP() []byte {
	file_metrics_types_types_proto_rawDescOnce.Do(func() {
		file_metrics_types_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_metrics_types_types_proto_rawDesc), len(file_metrics_types_types_proto_rawDesc)))
	})
...
func file_metrics_types_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_types_types_proto_rawDesc), len(file_metrics_types_types_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
